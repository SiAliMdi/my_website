...
const highlights = [
  { icon: '🎓', text: "مرشح لنيل درجة الدكتوراه", color: "from-blue-500 to-cyan-500" },
...
export const heroContent = {
  ...
  subtitle:
    "مرشح لنيل درجة الدكتوراه في معالجة اللغات الطبيعية ومتحمس للذكاء الاصطناعي ومطور برامج متكامل",
